export const BottomArrow = () => (
    <svg width="10" height="7" viewBox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
        <line x1="0.707107" y1="1.29289" x2="5.70711" y2="6.29289" stroke="#102C57" strokeWidth="2" />
        <line x1="4.29289" y1="6.29289" x2="9.29289" y2="1.29289" stroke="#102C57" strokeWidth="2" />
    </svg>
);
...
export const LineIcon = () => (
    <svg width="2" height="191" viewBox="0 0 2 191" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M0.499995 191L0.500004 0L1.5 4.37114e-08L1.5 191L0.499995 191Z" fill="#102C57" />
    </svg>
);

export const LineHIcon = () => (
    <svg width="511" height="2" viewBox="0 0 511 2" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillRule="evenodd" clipRule="evenodd" d="M511 1.5H0V0.5H511V1.5Z" fill="#DAC0A3" />
    </svg>
);
